...
public class MenuView extends ViewGroup {
	...
	private void init() {
		ScrollView sv = new ScrollView(context);// to ScrollView mpenei panw sto
												// layout tou activity
...
//		addMenuButtons(layout, "Info");
	...
	private void addMenuButtons(LinearLayout layout, String text) {
		...
		layout.addView(button, new LinearLayout.LayoutParams(context
				.getWindowManager().getDefaultDisplay().getWidth(), context
				.getWindowManager().getDefaultDisplay().getHeight() / 6));
	}
